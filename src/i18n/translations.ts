...
const translations: TranslationMap = {
  en: {
    ...
    "error.noLanguages":
      "No languages configured. Please add at least one language in the admin panel.",
  ...
  fr: {
    ...
    "lang.switch": "Langue",
    "error.noLanguages":
      "Aucune langue configurée. Veuillez ajouter au moins une langue dans le panneau d'administration.",
...
/**
 * Translate a field on a PocketBase record.
 * tf(project, "title", "en") → project.title_en
 */
